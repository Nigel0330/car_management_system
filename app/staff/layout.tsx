      ...
      <aside style={{ width: '220px', background: '#1C3A5E', color: 'white', padding: '1.5rem 1rem', flexShrink: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <a href="/staff" style={{ color: 'white', textDecoration: 'none', padding: '8px 12px', borderRadius: '8px', fontSize: '13px', opacity: 0.85 }}>Dashboard</a>
            <a href="/staff/clients" style={{ color: 'white', textDecoration: 'none', padding: '8px 12px', borderRadius: '8px', fontSize: '13px', opacity: 0.85 }}>Clients</a>
            <a href="/staff/services" style={{ color: 'white', textDecoration: 'none', padding: '8px 12px', borderRadius: '8px', fontSize: '13px', opacity: 0.85 }}>Services</a>
          </nav>
        </div>
